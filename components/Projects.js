...
export default function Projects() {
    ...
    const projectInfo = [
        ...
        { title: 'Snake', description: 'Snake, the timeless arcade game, is back! In snake, players control a snake with never ending hunger as it navigates through a field in search of food!', imageSrc: '/snake.png', github: 'https://github.com/Slmbyn/Snake', site:'#' },
      ];
  return (
