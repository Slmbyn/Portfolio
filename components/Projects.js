...
export default function Projects() {
    ...
    const projectInfo = [
        { title: 'StratTester', description: 'A web application that helps stock traders test and analyze data from various trading strategies.', imageSrc: '/strattester.png', github: 'https://github.com/Slmbyn/strattester'},
        { title: 'PushStart', description: 'PushStart is a full-stack CRUD application that seamlessly connects car buyers & sellers.', imageSrc: '/pushstart.png', github: 'https://github.com/Slmbyn/PushStart'},
